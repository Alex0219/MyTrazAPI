...
public class NameTags {
    ...
    public static void createScoreboardTeam() {
        ...
        Bootstrap.getInstance().getMainScoreboard().registerNewTeam("004Premium").setColor(ChatColor.GOLD);;
        ...
        Bootstrap.getInstance().getMainScoreboard().getTeam("004Premium").setPrefix("§6Premium §7| §6");
    ...
    public static void setTags(final Player player) {
        ...
        if (s.equalsIgnoreCase("superadmin".toLowerCase())) {
            ...
            userGroup = "004Premium";
            player.setDisplayName("§6Premium §7| §6" + player.getName());
